...
function() {
        ...
        var r, i; (function() {
            function n(e) {
                ...
                return function(n, r, i, o) {
                    ...
                    a = (s || n).length,
                    u = e > 0 ? 0 : a - 1;
                    return arguments.length < 3 && (i = n[s ? s[u] : u], u += e),
                    t(n, r, i, s, u, a)
                }
            }
            function o(e) {
            ...
            function s(e, t, n) {
                return function(r, i, o) {
                    ...
                    r[o] === i ? o: -1;
                    if (i !== i) return o = t(p.call(r, s, a), S.isNaN),
                    o >= 0 ? o + s: -1;
            ...
            function a(e, t) {
                ...
                o = "constructor";
                for (S.has(e, o) && !S.contains(t, o) && t.push(o); n--;) o = R[n],
                o in e && e[o] !== i[o] && !S.contains(t, o) && t.push(o)
            }
            var u = this,
            c = u._,
            l = Array.prototype,
            ...
            S.each = S.forEach = function(e, t, n) {
                t = O(t, n);
                var r, i;
                if (x(e)) for (r = 0, i = e.length; r < i; r++) t(e[r], r, e);
                else {
                    var o = S.keys(e);
            ...
            S.shuffle = function(e) {
                for (var t, n = x(e) ? e: S.values(e), r = n.length, i = Array(r), o = 0; o < r; o++) t = S.random(0, o),
                t !== o && (i[o] = i[t]),
                i[t] = n[o];
                return i
            },
            ...
            S.object = function(e, t) {
                for (var n = {},
                r = 0,
                i = C(e); r < i; r++) t ? n[e[r]] = t[r] : n[e[r][0]] = e[r][1];
                return n
            },
            S.findIndex = o(1),
            S.findLastIndex = o( - 1),
            ...
            S.partial = function(e) {
                ...
                n = function() {
                    for (var r = 0,
                    i = t.length,
                    o = Array(i), s = 0; s < i; s++) o[s] = t[s] === S ? arguments[r++] : t[s];
            ...
            S.memoize = function(e, t) {
                var n = function(r) {
                    ...
                    return S.has(i, o) || (i[o] = e.apply(this, arguments)),
                    i[o]
                };
                return n.cache = {},
                n
            ...
            S.throttle = function(e, t, n) {
                ...
                return function() {
                    ...
                    return r = this,
                    i = arguments,
                    l <= 0 || l > t ? (s && (clearTimeout(s), s = null), a = c, o = e.apply(r, i), s || (r = i = null)) : s || n.trailing === !1 || (s = setTimeout(u, l)),
                    o
                }
            },
            ...
            S.mapObject = function(e, t, n) {
                t = A(t, n);
                for (var r, i = S.keys(e), o = i.length, s = {},
                a = 0; a < o; a++) r = i[a],
                s[r] = t(e[r], r, e);
                return s
            },
            ...
            S.template = function(e, t, n) { ! t && n && (t = n),
                ...
                e.replace(r,
                function(t, n, r, s, a) {
                    return o += e.slice(i, a).replace(V, W),
                    i = a + t.length,
    ...
    function(e, t, n) {
        ...
        g = function(e, t, n) {
            ...
            s = arguments[4],
            u = m++;
            return o("request(" + u + ")", e, t, n, r),
            new a(function(a, c) {
                var l = i(e, t).set(r).send(n);
                s && l.on("progress", s),
                l.end(function(e, t) {
                    return t && o("response(" + u + ")", t.status, t.body || t.text, t.header),
                    e ? (t && (e.statusCode = t.status, e.responseText = t.text, e.response = t.body), c(e)) : a(t.body)
                })
            })
        },
        b = function(e, t) {
        ...
        w = function() {
            ...
            r ? l.masterKey ? t ? n["X-LC-Sign"] = v(l.masterKey, !0) : n["X-LC-Key"] = l.masterKey + ",master": (console.warn("masterKey is not set, fall back to use appKey"), b(n, t)) : b(n, t),
            l.hookKey && (n["X-LC-Hook-Key"] = l.hookKey),
            null !== l._config.applicationProduction && (n["X-LC-Prod"] = String(l._config.applicationProduction)),
        ...
        S = function(e, t, n, i, o) {
            ...
            if ("/" !== s.charAt(s.length - 1) && (s += "/"), s += "1.1/" + e, t && (s += "/" + t), n && (s += "/" + n), "users" !== e && "classes" !== e || !o || (s += "?", o._fetchWhenSave && (delete o._fetchWhenSave, s += "&new=true"), o._where && (s += "&where=" + encodeURIComponent(JSON.stringify(o._where)), delete o._where)), "get" === i.toLowerCase()) {
                s.indexOf("?") === -1 && (s += "?");
                for (var a in o)"object" === r(o[a]) && (o[a] = JSON.stringify(o[a])),
                s += "&" + a + "=" + encodeURIComponent(o[a])
            }
            return s
        },
        O = function(e, t) {
            return "number" != typeof t && (t = 3600),
            u.setAsync("APIServerURL", e, 1e3 * t)
        },
        A = function(e) {
        ...
        j = function() {
            ...
            return g("get", e).then(function(e) {
                if (e.api_server) return E(e.api_server),
                O(e.api_server, e.ttl)
            },
            function(e) {
        ...
        "use strict"; (function(t) {
            ...
            a._getInstallationId = function() {
                ...
                return a.localStorage.getItemAsync(e).then(function(t) {
                    ...
                    return a._installationId = n() + n() + "-" + n() + "-" + n() + "-" + n() + "-" + n() + n() + n(),
                    a.localStorage.setItemAsync(e, a._installationId)
                })
            },
            ...
            a._encode = function(e, t, n) {
                if (e instanceof a.Object) {
                    ...
                    if (!e.dirty()) return t = t.concat(e),
                    a._encode(e._toFullJSON(t), t, n);
            ...
            a._traverse = function(e, t, n) {
                ...
                return e instanceof a.Relation || e instanceof a.File ? t(e) : r.isArray(e) ? (r.each(e,
                function(r, i) {
                    var o = a._traverse(r, t, n);
                    o && (e[i] = o)
                }), t(e)) : r.isObject(e) ? (a._each(e,
                function(r, i) {
                    var o = a._traverse(r, t, n);
                    o && (e[i] = o)
                }), t(e)) : t(e)
    ...
    function(e, t, n) {
        ...
        function h(e, t) {
            ...
            function() {
                ...
                n.emit("response", t);
                var r;
                try { (t.status < 200 || t.status >= 300) && (r = new Error(t.statusText || "Unsuccessful HTTP response"), r.original = e, r.response = t, r.status = t.status)
                } catch(e) {
                    r = e
                }
        ...
        f.prototype._parseBody = function(e) {
            ...
            return ! t && u(this.type) && (t = m.parse["application/json"]),
        ...
        h.prototype.end = function(e) {
            ...
            if (this.hasListeners("progress")) try {
                n.onprogress = s.bind(null, "download"),
                n.upload && (n.upload.onprogress = s.bind(null, "upload"))
            } catch(e) {}
            ...
            i)), this._appendQueryString(), this.username && this.password ? n.open(this.method, this.url, !0, this.username, this.password) : n.open(this.method, this.url, !0), this._withCredentials && (n.withCredentials = !0), "GET" != this.method && "HEAD" != this.method && "string" != typeof o && !this._isHost(o)) {
                ...
                c = this._serializer || m.serialize[a ? a.split(";")[0] : ""]; ! c && u(a) && (c = m.serialize["application/json"]),
                c && (o = c(o))
            }
            ...
            n.send("undefined" != typeof o ? o: null),
            this
        },
        m.Request = h,
    ...
    function(e, t, n) {
        ...
        function s(e) {
            _ && (_._readyState = d, _.dispatchEvent({
                type: "error",
                message: e.errMsg
            }))
        }
        ...
        var v = function(e) {
            ...
            a(t, [{
                key: "close",
                value: function() {
                    this.readyState === l && console.warn("close WebSocket which is connecting might not work"),
                    wx.closeSocket()
                }
            },
            {
    ...
    function(e, t, n) {
        ...
        t.setAsync = function(e, t, n) {
            ...
            r.setItemAsync(i.applicationId + "/" + e, JSON.stringify(o))
        }
    },
    function(e, t, n) {
        "use strict";
        ...
        _.prototype = Object.create((p ? window.EventTarget: Object).prototype, {
            ...
            addEventListener: {
                value: function(e, t, n) {
                    ...
                    var r = n ? a: u,
                    i = this[s][e];
                    if (null == i) return this[s][e] = l(t, r),
                    !0;
            ...
            removeEventListener: {
                value: function(e, t, n) {
                    ...
                    for (var r = n ? a: u, i = null, o = this[s][e]; null != o;) {
                        if (o.listener === t && o.kind === r) return null == i ? this[s][e] = o.next: i.next = o.next,
                        !0;
                        i = o,
                        o = o.next
                    }
    ...
    function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.File = function(i, o, s) {
                ...
                this.set("mime_type", s), r.isArray(o) && (this.attributes.metaData.size = o.length, o = {
                    base64: f(o)
                }), o && o.base64) {
                    var u = n(46),
                    l = u(o.base64, s);
                ...
                } else if (o && o.blob) o.blob.type || (o.blob.type = s),
                this._extName = t(o.blob.uri),
                this._source = c.resolve({
                    data: o.blob,
                    type: s
                });
                else if ("undefined" != typeof File && o instanceof File) o.size && (this.attributes.metaData.size = o.size),
                o.name && (this._extName = t(o.name)),
                this._source = c.resolve({
                    data: o,
                    type: s
                });
                else if ("undefined" != typeof Buffer && Buffer.isBuffer(o)) this.attributes.metaData.size = o.length,
                this._source = c.resolve({
                    data: o,
                    type: s
                });
            ...
            e.File.prototype = {
                ...
                _fileToken: function(e) {
                    var n = this,
                    r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "fileTokens",
                    ...
                    this._qiniu_key = a,
                    u(r, null, null, "POST", c).then(function(e) {
                        return e.mime_type && n.set("mime_type", e.mime_type),
                        e
                    })
                },
                save: function(e) {
        ...
        e.exports = function(e) {
            ...
            r.extend(e.Object.prototype, e.Events, {
                ...
                escape: function(e) {
                    ...
                    return n = s.isNullOrUndefined(i) ? "": r.escape(i.toString()),
                ...
                set: function(t, n, i) {
                    var o;
                    if (r.isObject(t) || s.isNullOrUndefined(t) ? (o = r.mapObject(t,
                    function(t, n) {
                        return u(n),
                        e._decode(t, n)
                    }), i = n) : (o = {},
                    u(t), o[t] = e._decode(n, t)), i = i || {},
                    !o) return this;
                    ...
                    return e._arrayEach(r.keys(o),
                    function(t) {
                        var n = o[t];
                        n instanceof e.Relation && (n.parent = c),
                        n instanceof e.Op || (n = new e.Op.Set(n));
                        var s = !0;
                        n instanceof e.Op.Set && r.isEqual(c.attributes[t], n.value) && (s = !1),
                        s && (delete l[t], i.silent ? c._silent[t] = !0 : i.changes[t] = !0);
                        var a = r.last(c._opSetQueue);
                        a[t] = n._mergeWithPrevious(a[t]),
                        c._rebuildEstimatedDataForKey(t),
                        s ? (c.changed[t] = c.attributes[t], i.silent || (c._pending[t] = !0)) : (delete c.changed[t], delete c._pending[t])
                    }),
                ...
                fetch: function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    t = arguments[1];
                    r.isArray(e.keys) && (e.keys = e.keys.join(",")),
                    r.isArray(e.include) && (e.include = e.include.join(","));
                    var n = this,
                ...
                save: function(t, n, i) {
                    var a, u, c;
                    r.isObject(t) || s.isNullOrUndefined(t) ? (a = t, c = n) : (a = {},
                    a[t] = n, c = i),
                    c = r.clone(c) || {},
                    c.wait && (u = r.clone(this.attributes));
                    var l = r.clone(c) || {};
                    l.wait && (l.silent = !0),
                    a && this.set(a, l);
                    var f = this;
                    ...
                    var h = [],
                    d = [];
                    return e.Object._findUnsavedChildren(f.attributes, h, d),
                    h.length + d.length > 0 ? e.Object._deepSaveAsync(this.attributes, f, c).then(function() {
            ...
            e.Object._deepSaveAsync = function(t, n, s) {
                ...
                return c.then(function() {
                    ...
                    function() {
                        ...
                        var a = e.Promise.resolve(r.map(t,
                        function(t) {
        ...
        e.exports = function(e) {
            ...
            e.Query.prototype = {
                ...
                get: function(e, t) {
                    ...
                    var s = r.toJSON(),
                    a = {};
                    return s.keys && (a.keys = s.keys),
                    s.include && (a.include = s.include),
                    o.fetch(a, t)
                },
                toJSON: function() {
                    var t = {
                ...
                skip: function(e) {
                    return u(e, "undefined is not a valid skip value"),
                    this._skip = e,
                    this
                },
                limit: function(e) {
                    return u(e, "undefined is not a valid limit value"),
                    this._limit = e,
                    this
                },
                equalTo: function(t, n) {
                    return u(t, "undefined is not a valid key"),
                    u(n, "undefined is not a valid value"),
                    this._where[t] = e._encode(n),
                    this
                },
                _addCondition: function(t, n, r) {
                    return u(t, "undefined is not a valid condition key"),
                ...
                ascending: function(e) {
                    return u(e, "undefined is not a valid key"),
                    this._order = e,
                    this
                },
    ...
    function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.Relation.prototype = {
                ...
                query: function t() {
                    var n, t;
                    return this.targetClassName ? (n = e.Object._getSubclass(this.targetClassName), t = new e.Query(n)) : (n = e.Object._getSubclass(this.parent.className), t = new e.Query(n), t._extraOptions.redirectClassNameForKey = this.key),
    ...
    function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.Status = function(e, t) {
                ...
                this.query = null,
                e && "object" === ("undefined" == typeof e ? "undefined": r(e)) ? this.data = e: (e && (this.data.image = e), t && (this.data.message = t)),
                this
            },
            e.Status.prototype = {
                get: function(e) {
                ...
                send: function() {
                    ...
                    return this.query ? n(r).then(function(e) {
                        ...
                        o("statuses", null, null, "POST", i, r.sessionToken)
                    }).then(function(n) {
            ...
            e.Status.countUnreadStatuses = function(n) {
                ...
                return t(r).then(function(t) {
                    var n = {};
                    return n.inboxType = e._encode(s),
                    n.owner = e._encode(t),
                    o("subscribe/statuses/count", null, null, "GET", n, r.sessionToken)
                })
            },
    ...
    function(e, t, n) {
        ...
        e.exports = function(e, t, n) {
            ...
            return new o(function(e, o) {
                ...
                u.end(function(t, r) {
                    return r && i(r.status, r.body, r.text),
                    t ? (r && (t.statusCode = r.status, t.responseText = r.text, t.response = r.body), o(t)) : void e(n)
                })
            })
        }
    },
    function(e, t, n) {
        ...
        e.exports = function(e, t, n) {
            ...
            return new i(function(e, i) {
                ...
                s.onprogress && u.on("progress", s.onprogress),
                u.end(function(t, r) {
                    return r && o(r.status, r.body, r.text),
                    t ? (r && (t.statusCode = r.status, t.responseText = r.text, t.response = r.body), i(t)) : void e(n)
                })
            })
        }
    },
    function(e, t, n) {
        ...
        e.exports = function(e, t, n) {
            ...
            new Promise(function(o, s) {
                ...
                i.onprogress && a.on("progress", i.onprogress),
                a.end(function(e, t) {
        ...
        e.exports = function(e) {
            e.User = e.Object.extend("_User", {
                ...
                _handleSaveResult: function(t) {
                    ...
                    this._refreshCache(),
                    !t && !this.isCurrent() || e._config.disableCurrentUser ? s.resolve() : s.resolve(e.User._saveCurrentUser(this))
                },
                ...
                save: function(t, n, i) {
                    ...
                    o[t] = n, s = i),
                    s = s || {},
                    e.Object.prototype.save.call(this, o, s).then(function(e) {
            ...
            },
            {
                ...
                _saveCurrentUser: function(t) {
                    var n;
                    return n = e.User._currentUser !== t ? e.User.logOut() : s.resolve(),
                    n.then(function() {
                        t._isCurrentUser = !0,
    ...
    function(e, t, n) { (function(t) { !
            ...
            function() {
                ...
                function w(e, t) {
                    t._state === oe ? E(e, t._result) : t._state === se ? j(e, t._result) : T(t, void 0,
                    function(t) {
                        return O(e, t)
                    },
                    function(t) {
                ...
                function R(e, t) {
                    ...
                    Q(t) ? (this._input = t, this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), 0 === this.length ? E(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(), 0 === this._remaining && E(this.promise, this._result))) : j(this.promise, D())
                }
                function D() {
                ...
                function J(e) {
                    ...
                    this._subscribers = [],
                    _ !== e && ("function" != typeof e && F(), this instanceof J ? I(this, e) : B())
                }
                function V() {
                    var e = void 0;
                ...
                return R.prototype._enumerate = function() {
                    ...
                    t = this._input,
                    n = 0; this._state === ie && n < e; n++) this._eachEntry(t[n], n)
                },
                ...
                R.prototype._settledAt = function(e, t, n) {
                    var r = this.promise;
                    r._state === ie && (this._remaining--, e === se ? j(r, n) : this._result[t] = n),
    ...
    function(e, t, n) {
        ...
        function i(e, t, n) {
            ...
            for (var r = null,
            i = e[s][t]; null != i;) i.kind === a ? null == r ? e[s][t] = i.next: r.next = i.next: r = i,
            i = i.next;
