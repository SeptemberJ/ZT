var add = [
...

    {
        "name": "台湾", "city": [
            ...
            { "name": "台北市", "area": ["中正区","大同区","中山区","松山区","大安区","万华区","信义区","士林区","北投区","内湖区","南港区","文山区","其他区"]},

            { "name": "高雄市", "area": ["新兴区","前金区","芩雅区","盐埕区","鼓山区","旗津区","前镇区","三民区","左营区","楠梓区","小港区","苓雅区","仁武区","大社区","冈山区","路竹区","阿莲区","田寮区","燕巢区","桥头区","梓官区","弥陀区","永安区","湖内区","凤山区","大寮区","林园区","鸟松区","大树区","旗山区","美浓区","六龟区","内门区","杉林区","甲仙区","桃源区","那玛夏区","茂林区","茄萣区",] },
            { "name": "台南市", "area": ["其他"] },
            { "name": "台中市", "area": ["其他"] },
            { "name": "金门县", "area": ["金沙镇","金湖镇","金宁镇","金城镇","烈屿镇","乌坵镇"] },
            { "name": "南投县", "area": ["其他"] },
            { "name": "基隆市", "area": ["仁爱区","信义区","中正区","中山区","安乐区","暖暖区","七堵区","其它区"] },
            { "name": "新竹市", "area": ["东区","北区","香山区","其它区"] },
            { "name": "嘉义市", "area": ["东区","西区","其它区"] },
            { "name": "辛北市", "area": ["其他"] },
            { "name": "宜兰县", "area": ["其他"] },
            { "name": "新竹县", "area": ["其他"] },
            { "name": "桃园县", "area": ["其他"] },
            ...
            { "name": "云林县", "area": ["其他"] },
            { "name": "屏东县", "area": ["其他"] },
            { "name": "台东县", "area": ["台东市","绿岛乡","烂屿乡","延平乡","卑南乡","鹿野乡","关山镇","海瑞乡","池上乡","东河乡","成功镇","长滨乡","金峰乡","大武乡","达仁乡","太麻里乡"] },
            { "name": "花莲县", "area": ["花莲市","新城乡","东鲁乡","秀林乡","吉安乡","寿丰乡","林凤镇","光复乡","丰滨乡","瑞穗乡","万荣乡","玉里镇","卓溪乡","富里乡"] },
            { "name": "澎湖县", "area": ["马公市","西屿乡","望安乡","七美乡","白沙乡","湖西乡"] },
            { "name": "连江县", "area": ["南竿乡","北竿乡","莒光乡","东引乡",] },
...

    {
        "name": "香港特别行政区", "city": [
            ...
            { "name": "香港岛", "area": ["中西区", "湾仔", "东区", "南区"] },
            { "name": "九龙", "area": [ "九龙城区", "油尖旺区","深水埗区","黄大仙区", "观塘区"] },
            { "name": "新界", "area": ["北区", "大埔区", "沙田区", "西贡区", "元朗区", "屯门区", "荃湾区", "葵青区", "离岛区"] }
